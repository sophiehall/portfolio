...
const {Engine, Render, Bodies, World, MouseConstraint, Mouse, Composites, Query} = Matter

// where is matter being deployed
const sectionTag = document.querySelector("div.shapes")
...
//     sectionTag.style.width = w;
//     sectionTag.style.height = h;
// });
...
const createShape = function (x, y) {
  ...
  if (randomNum > 0.7) {
    return Bodies.circle(x, y, 30, {
      render: {
        sprite: {
          texture: "images/motivo-bold-2x.png",
          xScale: 0.5,
          yScale: 0.5
        }
      }
    ...
    return Bodies.circle(x, y, 20, {
      render: {
        sprite: {
          texture: "images/capisce-display-2x.png",
          xScale: 0.5,
          yScale: 0.5
        }
      }
